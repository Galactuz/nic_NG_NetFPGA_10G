...
#ifdef DRIVER_DEBUG
#	ifdef __KERNEL__
# 		define PDEBUG(fmt, args...) printk(KERN_DEBUG "Eth_driver: DEBUG: " fmt, ## args)
# 	else
...
#define PCI_VENDOR_ID_ETH				0x10ee /* Vendor ID used for all NetFPGA-10G designs. */
#define PCI_DEVICE_ID_ETH_REF_NIC 		0x4243 /* Device ID used for the NetFPGA-10G reference NIC design. */
#define BAR_0 0
